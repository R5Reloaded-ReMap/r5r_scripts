...
void
function DoorMapEntitiesDidLoad() {
    thread door_map()
    thread lootbins()
...
function SpawnInfoText(entity player) {
    ...
    CreatePanelText(player, "1", "^", < 0.23, 359.44, 15038.53 > , < 0, 90, 0 > , false, 1)
    CreatePanelText(player, "2", ">", < 1.7361, 1296.582, 15037.6 > , < 0, 89.6289, 0 > , false, 1)
    CreatePanelText(player, "3", "<", < 809.8999, 1462.2, 15033 > , < 0, 0, 0 > , false, 1)
    ...
    CreatePanelText(player, "6", "<", < 1146.704, 2153.5, 15299.5 > , < 0, 0, 0 > , false, 1)
    CreatePanelText(player, "7", ">", < 678.6013, 2203.906, 15440 > , < 0, -180, 0 > , false, 1)
    CreatePanelText(player, "8", "^", < 1391.3, 2499.7, 15584.1 > , < 0, 0, 0 > , false, 1)
    CreatePanelText(player, "9", ">", < 2312.2, 2502.1, 15584.1 > , < 0, 0, 0 > , false, 1)
    CreatePanelText(player, "10", ">", < 2557.3, 1768, 15694 > , < 0, -90, 0 > , false, 1)
    CreatePanelText(player, "11", ">", < 2329.9, 2231.1, 15840.1 > , < 0, 90, 0 > , false, 1)
    CreatePanelText(player, "12", "^", < 2557.3, 1768, 15982 > , < 0, -90, 0 > , false, 1)
    CreatePanelText(player, "13", "^", < 2508.9, 805.1036, 15982.89 > , < 0, -90, 0 > , false, 1)
    CreatePanelText(player, "14", "^", < 2511.8, 130.1001, 15980.24 > , < 0, -90, 0 > , false, 1)
    CreatePanelText(player, "15", "<", < 2511.399, -509.1964, 15980.24 > , < 0, -90, 0 > , false, 1)
    CreatePanelText(player, "16", ">", < 2998.8, -914.4966, 15976.5 > , < 0, -90, 0 > , false, 1)
    CreatePanelText(player, "17", "up", < 2583.516, -1340.868, 15983.97 > , < 0, -90, 0 > , false, 1)
    CreatePanelText(player, "18", "^", < 1685.2, -1187.218, 16096.22 > , < 0, -180, 20 > , false, 1)
    CreatePanelText(player, "19", "^", < 757.1541, -1267.28, 16100.17 > , < 0, -180, -15 > , false, 1)
    CreatePanelText(player, "20", "^", <- 130.1465, -1232.896, 15970.39 > , < 20, -180, 0 > , false, 1)
    CreatePanelText(player, "21", "^", <- 1373.523, -1192.61, 16034.23 > , < 0, -180, 0 > , false, 1)
    CreatePanelText(player, "22", "up", <- 1946.399, -1234.21, 16158.97 > , < 0, -180, 0 > , false, 1)
    CreatePanelText(player, "23", "^", <- 2008.553, -1234.21, 16556.62 > , < 0, -180, 0 > , false, 1)
    CreatePanelText(player, "24", "up", <- 3030.099, -1234.21, 16526.93 > , < 0, -180, 0 > , false, 1)
    CreatePanelText(player, "25", "^", <- 2711.399, -358.8946, 17086.04 > , < 0, 90, 0 > , false, 1)
    CreatePanelText(player, "26", "^", <- 2828.199, 635.2054, 17225.34 > , < 0, 90, 0 > , false, 1)
    CreatePanelText(player, "27", "<", <- 2831.899, 1633.906, 17380.26 > , < 0, 90, 0 > , false, 1)
    CreatePanelText(player, "28", ">", <- 3031.799, 2445.006, 17519.66 > , < 0, 90, 0 > , false, 1)
    CreatePanelText(player, "29", "<", <- 2307.202, 2780.404, 17561.71 > , < 0, 0, 0 > , false, 1)
    CreatePanelText(player, "30", "<", <- 2192.393, 3687.328, 17561.71 > , < 0, 0, 0 > , false, 1)
    CreatePanelText(player, "31", "^", <- 2185.993, 4860.828, 17712.3 > , < 0, 0, 0 > , false, 1)
    CreatePanelText(player, "32", "<", <- 1441.793, 4762.328, 17712.3 > , < 0, -90, 0 > , false, 1)
    CreatePanelText(player, "33", "up", <- 926.0934, 3991.628, 17579.41 > , < 0, -90, 0 > , false, 1)
    CreatePanelText(player, "34", "^", <- 926.095, 3674.026, 17946.8 > , < 0, -90, 0 > , false, 1)
    CreatePanelText(player, "35", "<", <- 926.0933, 2880.628, 18294.15 > , < 0, -90, 0 > , false, 1)
    CreatePanelText(player, "36", "^", < 137.6069, 2358.228, 17994.05 > , < 0, 0, 0 > , false, 1)
    CreatePanelText(player, "37", "^", < 1174.307, 2358.525, 18285.61 > , < 0, 0, 0 > , false, 1)
    CreatePanelText(player, "38", "<", < 1930.58, 2357.525, 18625.11 > , < 0, 0, 0 > , false, 1)
    CreatePanelText(player, "39", "<", < 1930.584, 2703.522, 18836.21 > , < 0, 0, 0 > , false, 1)
    CreatePanelText(player, "40", "<", < 1737.381, 3049.821, 19047.61 > , < 0, 180, 0 > , false, 1)
    CreatePanelText(player, "41", "<", < 1737.379, 2703.821, 19258.71 > , < 0, 180, 0 > , false, 1)
    CreatePanelText(player, "42", "<", < 1737.38, 2358.223, 19469.21 > , < 0, 180, 0 > , false, 1)
    CreatePanelText(player, "43", "up", < 1837.904, 1928.428, 19637.9 > , < 0, -90.0002, 0 > , false, 1)
    CreatePanelText(player, "44", "^", < 1837.905, 739.2283, 19695.3 > , < 0, -90.0001, 0 > , false, 1)
...
function lootbins_buttons() {
    // Buttons
    AddCallback_OnUseEntity(CreateFRButton( < 107.3301, 124.84, 14914.9 > , < 0, -90, 0 > , "%use% Start Timer"), void
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 1837.905, 129.0281, 19747.3 > , < 0, -180, 0 > , "%use% Stop Timer"), void
        function(entity panel, entity user, int input) {
            int reset = 0
    ...
    AddCallback_OnUseEntity(CreateFRButton( <- 112.47, 124.84, 14915.13 > , < 0, 90, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
                        ...
                        LocalMsg(user, "#HUB_CANT_USE_TIMER_RUNNING", "", 4, 5.0, "", "", "" )
                    }
                }
            }
        })

    AddCallback_OnUseEntity(CreateFRButton( <- 106.8, 933.2, 14914.2 > , < 0, 89.6289, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 449, 1567.4, 14915.5 > , < 0, 0, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 936, 1906, 14916.1 > , < 0, 90, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 1041.8, 2046.1, 15045.7 > , < 0, -180, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 784.8, 2266.2, 15176.1 > , < 0, 0, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 1041.8, 2155.8, 15321.5 > , < 0, -180, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 1035.4, 2602, 15465.4 > , < 0, 0, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 1947.9, 2615.7, 15466.1 > , < 0, 0, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 2612.4, 2127.3, 15575.5 > , < 0, -90, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 2275.1, 1872.1, 15721.6 > , < 0, 90, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 2610.1, 2130.6, 15863.5 > , < 0, -90, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 2613.7, 1166.7, 15865.99 > , < 0, -90, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 2619, 235, 15863.94 > , < 0, -90, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 2622.899, -401.3965, 15864.24 > , < 0, -90, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 3113.3, -811.0966, 15860.7 > , < 0, -90, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 2676.8, -1300.1, 15867.37 > , < 0, -90, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 2047.8, -1331.4, 16024.3 > , < 0, -180, 20 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 1120.6, -1339.5, 15960.1 > , < 0, -180, -20 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 251.9, -1343.8, 15985 > , < 20, -180, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( <- 779.7988, -1342.594, 15743.93 > , < 0, -180, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( <- 1864.661, -1350.932, 16034.8 > , < 0, -180, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( <- 2903.943, -1340.1, 16436.13 > , < 0, -180, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( <- 2890.073, -621.6021, 16912.13 > , < 0, 90, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( <- 2889.573, 127.3, 17051.43 > , < 0, 90, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( <- 2891.399, 1119.8, 17190.83 > , < 0, 90, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( <- 3196.1, 1920.9, 17330.23 > , < 0, 90, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( <- 2774.602, 2890.904, 17469.41 > , < 0, 0, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( <- 2499.4, 3799.4, 17469.41 > , < 0, 0, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( <- 2286.825, 4978.426, 17469.61 > , < 0, 0, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( <- 1324.195, 4863.159, 17469.61 > , < 0, -90, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( <- 814.8521, 4116, 17470.01 > , < 0, -90, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( <- 814.8949, 3789.826, 17724.71 > , < 0, -90, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( <- 815, 3271, 18038.05 > , < 0, -90, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 19.2999, 2469.2, 17930.45 > , < 0, 0, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 1061.8, 2469.525, 18157.5 > , < 0, 0, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 1818.9, 2471.5, 18449.51 > , < 0, 0, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 1821.3, 2817.5, 18660.61 > , < 0, 0, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 1824.3, 3156.3, 18872.01 > , < 0, 0, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 1823.1, 2589.821, 19083.11 > , < 0, 180, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 1830.3, 2244.223, 19293.61 > , < 0, 180, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 1952, 2042, 19518.4 > , < 0, -90.0002, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 1949.7, 973, 19629.61 > , < 0, -90.0001, 0 > , "%use% Skip jump"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (user.GetPersistentVarAsInt("gen") == 0) {
