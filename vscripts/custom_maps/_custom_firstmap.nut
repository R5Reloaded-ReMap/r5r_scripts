...
void
function FirstMapEntitiesDidLoad() {
...
function Firstmap_player_setup(entity player) {
    ...
    LocalMsg(player, "#HUB_MAP_FIRST", "", 9, 5.0, "", "By: Treeree & JayTheYggDrasil & Loy", "" )
...
function Firstmap_load() {
    ...
    MapEditor_CreateProp( $"mdl/thunderdome/thunderdome_cage_ceiling_256x256_06.rmdl", < 6236.725, 2856, 16564 >, < 0, -90, 0 >, true, 50000, -1, 1 )
    ...
    MapEditor_CreateProp( $"mdl/thunderdome/thunderdome_cage_ceiling_256x256_06.rmdl", < 6236.725, 2856, 16323.6 >, < 0, -90, 0 >, true, 50000, -1, 1 )
    ...
    NoCollisionArray.append( MapEditor_CreateProp( $"mdl/signs/street_sign_arrow.rmdl", < 3592.106, 6858.006, 19804.81 >, < 90, -179.9996, 0 >, true, 50000, -1, 1.6815 ) )
    ...
    MapEditor_CreateProp( $"mdl/thunderdome/thunderdome_cage_wall_128x352_04.rmdl", < 3247.725, 2597, 16395.81 >, < 0, 0, 0 >, false, 50000, -1, 1 )
    ...
    MapEditor_CreateProp( $"mdl/thunderdome/thunderdome_cage_ceiling_256x256_06.rmdl", < 7131.725, 6943.33, 16059.04 >, < 0, 179.9999, 0 >, true, 50000, -1, 1 )
    ...
    MapEditor_CreateProp( $"mdl/desertlands/industrial_cargo_container_320_01.rmdl", < 3767.225, 2921.6, 16594.88 >, < 0, -90, 179.9998 >, true, 50000, -1, 1 )
    ...
    NoCollisionArray.append( MapEditor_CreateProp( $"mdl/lamps/floor_standing_ambient_light.rmdl", < 1755.419, 3086.792, 16018.48 >, < 0, -179.9997, 0 >, true, 50000, -1, 1 ) )
    ...
    MapEditor_CreateProp( $"mdl/thunderdome/thunderdome_cage_wall_128x352_04.rmdl", < 365.7246, 2984, 16154.81 >, < 0, 0, 0 >, false, 50000, -1, 1 )
    MapEditor_CreateProp( $"mdl/thunderdome/thunderdome_cage_wall_128x352_04.rmdl", < 4184.725, 3168.88, 16523.81 >, < 0, 0, 0 >, false, 50000, -1, 1 )
    ...
    MapEditor_CreateProp( $"mdl/thunderdome/thunderdome_cage_wall_128x352_04.rmdl", < 493.7246, 2984, 16154.81 >, < 0, 0, 0 >, false, 50000, -1, 1 )
    ...
    MapEditor_CreateProp( $"mdl/thunderdome/thunderdome_cage_ceiling_256x256_06.rmdl", < 1645.726, 2982, 16002.48 >, < 0, 0.0001, 0 >, true, 50000, -1, 1 )
    ...
    MapEditor_CreateProp( $"mdl/thunderdome/thunderdome_cage_wall_128x352_04.rmdl", < -722.2754, 3947, 16297.81 >, < 0, 0, 0 >, false, 50000, -1, 1 )
    ...
    MapEditor_CreateProp( $"mdl/thunderdome/thunderdome_cage_wall_128x352_04.rmdl", < 4056.725, 3168.88, 16523.81 >, < 0, 0, 0 >, false, 50000, -1, 1 )
    MapEditor_CreateProp( $"mdl/thunderdome/thunderdome_cage_wall_128x352_04.rmdl", < -82.2754, 3431, 16187.81 >, < 0, 0, 0 >, false, 50000, -1, 1 )
    ...
    MapEditor_CreateProp( $"mdl/thunderdome/thunderdome_cage_ceiling_256x256_06.rmdl", < -914.2744, 4262, 16514.48 >, < 0, -89.9999, 0 >, true, 50000, -1, 1 )
    ...
    MapEditor_CreateProp( $"mdl/thunderdome/thunderdome_cage_wall_128x352_04.rmdl", < 3375.725, 2597, 16395.81 >, < 0, 0, 0 >, false, 50000, -1, 1 )
    ...
    MapEditor_CreateProp( $"mdl/thunderdome/thunderdome_cage_wall_128x352_04.rmdl", < -594.2754, 3947, 16297.81 >, < 0, 0, 0 >, false, 50000, -1, 1 )
    ...
    MapEditor_CreateProp( $"mdl/thunderdome/thunderdome_cage_wall_128x352_04.rmdl", < 45.7246, 3431, 16187.81 >, < 0, 0, 0 >, false, 50000, -1, 1 )
    ...
    // Buttons
    AddCallback_OnUseEntity(CreateFRButton( < 7254.493, 6938.447, 16075.16 > , < 0, -89.9998, 0 > , "%use% Start/Stop Timer"), void
    ...
    trigger_3.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                ...
                } else  if (file.cp_table[ent] != <7139.724, 6769.2, 16460.81>) {
        ...
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                ...
                if (gen != 0) {
                    ...
                    LocalMsg(ent, "#FS_STRING_VAR", "", 4, 5.0, format("%d:%02d", minutes, seconds), "", "" )
                } else  if (file.cp_table[ent] != <7131.725, 3951, 16387.81>) {
                    LocalMsg(ent, "#FS_STRING_VAR", "", 4, 5.0, "CHECKPOINT", "", "" )
                }
        ...
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                ...
                if (gen != 0) {
                    ...
                    LocalMsg(ent, "#FS_STRING_VAR", "", 4, 5.0, format("%d:%02d", minutes, seconds), "", "" )
                } else  if (file.cp_table[ent] != <7220.724, 2848, 16406.81>) {
                    LocalMsg(ent, "#FS_STRING_VAR", "", 4, 5.0, "CHECKPOINT", "", "" )
                }
        ...
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                ...
                if (gen != 0) {
                    ...
                    LocalMsg(ent, "#FS_STRING_VAR", "", 4, 5.0, format("%d:%02d", minutes, seconds), "", "" )
                } else  if (file.cp_table[ent] != <6325.724, 2848, 16389>) {
                    LocalMsg(ent, "#FS_STRING_VAR", "", 4, 5.0, "CHECKPOINT", "", "" )
                }
        ...
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                ...
                if (gen != 0) {
                    ...
                    LocalMsg(ent, "#FS_STRING_VAR", "", 4, 5.0, format("%d:%02d", minutes, seconds), "", "" )
                } else  if (file.cp_table[ent] != <5860.725, 2848, 16497.81>) {
                    LocalMsg(ent, "#FS_STRING_VAR", "", 4, 5.0, "CHECKPOINT", "", "" )
                }
        ...
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                ...
                if (gen != 0) {
                    ...
                    LocalMsg(ent, "#FS_STRING_VAR", "", 4, 5.0, format("%d:%02d", minutes, seconds), "", "" )
                } else  if (file.cp_table[ent] != <5404, 2856, 16600.95>) {
                    LocalMsg(ent, "#FS_STRING_VAR", "", 4, 5.0, "CHECKPOINT", "", "" )
                }
        ...
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                ...
                if (gen != 0) {
                    ...
                    LocalMsg(ent, "#FS_STRING_VAR", "", 4, 5.0, format("%d:%02d", minutes, seconds), "", "" )
                } else  if (file.cp_table[ent] != <4647.843, 2767.852, 16708.81>) {
                    LocalMsg(ent, "#FS_STRING_VAR", "", 4, 5.0, "CHECKPOINT", "", "" )
                }
        ...
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                ...
                if (gen != 0) {
                    ...
                    LocalMsg(ent, "#FS_STRING_VAR", "", 4, 5.0, format("%d:%02d", minutes, seconds), "", "" )
                } else  if (file.cp_table[ent] != <3881.727, 2880.071, 16635.81>) {
                    LocalMsg(ent, "#FS_STRING_VAR", "", 4, 5.0, "CHECKPOINT", "", "" )
                }
        ...
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                ...
                if (gen != 0) {
                    ...
                    LocalMsg(ent, "#FS_STRING_VAR", "", 4, 5.0, format("%d:%02d", minutes, seconds), "", "" )
                } else  if (file.cp_table[ent] != <3006.381, 2829.343, 16516.81>) {
                    LocalMsg(ent, "#FS_STRING_VAR", "", 4, 5.0, "CHECKPOINT", "", "" )
                }
        ...
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                ...
                if (gen != 0) {
                    ...
                    LocalMsg(ent, "#FS_STRING_VAR", "", 4, 5.0, format("%d:%02d", minutes, seconds), "", "" )
                } else  if (file.cp_table[ent] != <1709.724, 2982, 16061.81>) {
                    LocalMsg(ent, "#FS_STRING_VAR", "", 4, 5.0, "CHECKPOINT", "", "" )
                }
        ...
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                ...
                if (gen != 0) {
                    ...
                    LocalMsg(ent, "#FS_STRING_VAR", "", 4, 5.0, format("%d:%02d", minutes, seconds), "", "" )
                } else  if (file.cp_table[ent] != <1050.724, 3029, 16259.81>) {
                    LocalMsg(ent, "#FS_STRING_VAR", "", 4, 5.0, "CHECKPOINT", "", "" )
                }
        ...
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                ...
                if (gen != 0) {
                    ...
                    LocalMsg(ent, "#FS_STRING_VAR", "", 4, 5.0, format("%d:%02d", minutes, seconds), "", "" )
                } else  if (file.cp_table[ent] != <570.3813, 3215.343, 16388.81>) {
                    LocalMsg(ent, "#FS_STRING_VAR", "", 4, 5.0, "CHECKPOINT", "", "" )
                }
        ...
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                ...
                if (gen != 0) {
                    ...
                    LocalMsg(ent, "#FS_STRING_VAR", "", 4, 5.0, format("%d:%02d", minutes, seconds), "", "" )
                } else  if (file.cp_table[ent] != <-133.6182, 3663.343, 16452.81>) {
                    LocalMsg(ent, "#FS_STRING_VAR", "", 4, 5.0, "CHECKPOINT", "", "" )
                }
        ...
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                ...
                if (gen != 0) {
                    ...
                    LocalMsg(ent, "#FS_STRING_VAR", "", 4, 5.0, format("%d:%02d", minutes, seconds), "", "" )
                } else  if (file.cp_table[ent] != <-977.2754, 4174, 16580.81>) {
                    LocalMsg(ent, "#FS_STRING_VAR", "", 4, 5.0, "CHECKPOINT", "", "" )
                }
