...
void
function Gymmovementmap_precache() {
...
void
function GymMovementMapEntitiesDidLoad() {
    thread Gymmovementmap_load()
}

void
function Gymmovementmap_player_setup(entity player) {
    ...
    LocalMsg(player, "#HUB_MAP_GYM", "#FS_STRING_VAR", 9, 5.0, "", "By: Loy Takian", "" )
...
function Gymmovementmap_load() {
    ...
    NoCollisionArray.append( MapEditor_CreateProp( $"mdl/Weapons/octane_epipen/w_octane_epipen.rmdl", < 7727, -10742, 15524 >, < -30.0001, -89.9998, 119.9657 >, true, 50000, -1, 5 ) )
    NoCollisionArray.append( MapEditor_CreateProp( $"mdl/Weapons/octane_epipen/w_octane_epipen.rmdl", < -3677, -9942, 17512 >, < -39.4678, -152.2212, -78.9297 >, true, 50000, -1, 5 ) )
    ...
    InvisibleArray.append( MapEditor_CreateProp( $"mdl/thunderdome/thunderdome_cage_wall_128x352_04.rmdl", < -3628, -10555, 17511 >, < 90, 0, 0 >, true, 50000, -1, 1 ) )
    InvisibleArray.append( MapEditor_CreateProp( $"mdl/thunderdome/thunderdome_cage_ceiling_256x256_06.rmdl", < -3500.001, -10563, 17703 >, < 90, 89.9998, 0 >, true, 50000, -1, 1 ) )
    InvisibleArray.append( MapEditor_CreateProp( $"mdl/thunderdome/thunderdome_cage_ceiling_256x256_06.rmdl", < -3408, -10564, 17703 >, < 90, 89.9998, 0 >, true, 50000, -1, 1 ) )
    InvisibleArray.append( MapEditor_CreateProp( $"mdl/thunderdome/thunderdome_cage_ceiling_256x256_06.rmdl", < -3188, -10565, 17727 >, < 90, 89.9998, 0 >, true, 50000, -1, 1 ) )
    ...
    InvisibleArray.append( MapEditor_CreateProp( $"mdl/thunderdome/thunderdome_cage_wall_128x352_04.rmdl", < -3062, -10333, 17511 >, < 90, 89.9998, 0 >, true, 50000, -1, 1 ) )
    ClipNoGrappleNoClimb.append( MapEditor_CreateProp( $"mdl/desertlands/construction_bldg_platform_01.rmdl", < 11489, -10457, 15707 >, < 0, 0, 89.9998 >, true, 50000, -1, 1 ) )
    ...
    // Buttons
    AddCallback_OnUseEntity(CreateFRButton( < 11437, -3709.917, 15144.11 > , < 0, -179.9997, 0 > , "%use% Start/Stop timer"), void
    ...
    AddCallback_OnUseEntity(CreateFRButton( <- 4738.3, -8878.9, 17488.22 > , < 0, 45, 0 > , "%use% Go back to start"), void
        function(entity panel, entity ent, int input) {
            if (IsValidPlayer(ent)) {
