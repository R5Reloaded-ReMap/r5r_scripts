untyped
global
function mantlejumpmap_init
global
function mantlemap_reset_doors

// Made by Loy and Treeree. 

void
function mantlemap_precache() {
...
function mantlemap_player_setup(entity player) {
    ...
    LocalMsg(player, "#HUB_MAP_MANTLE_JUMP", "#FS_STRING_VAR", 9, 5.0, "", "By: Loy & Treeree", "" )
...
void
function mantlemap_load() { // Props Array
    ...
    // Buttons
    AddCallback_OnUseEntity(CreateFRButton( < 1939.141, 14610.98, 32901.26 > , < 0, 179.9865, 0 > , "%use% Finish Timer/Go to Lobby"), void
        function(entity panel, entity user, int input) {
            if (IsValidPlayer(user)) {
                ...
                if (gen != 0) {
                    ...
                    LocalMsg(user, "#FS_STRING_VAR", "#HUB_CONGRATULATIONS", 2, 5.0, "EASY COURSE FINISHED!", "", "" )
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 2084.399, -6322.4, 18066 > , < 0, -0.0001, 0 > , "%use% Go to Easy Course"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 511.0371, -19286.22, 15076.09 > , < 0, 0, 0 > , "%use% Start/Stop Timer"), void
        function(entity panel, entity user, int input) {
            if (IsValidPlayer(user)) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 3208.55, 12481.08, 14079.62 > , < 0, -90, 0 > , "%use% Start/Stop Timer"), void
        function(entity panel, entity user, int input) {
            if (IsValidPlayer(user)) {
                if (user.GetPersistentVarAsInt("gen") == 0) {
                    array < ItemFlavor > characters = GetAllCharacters()
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 5001.053, -29432.39, 29325.23 > , < 0, 179.9934, -0.0001 > , "%use% Finish Timer/Go to Lobby"), void
        function(entity panel, entity user, int input) {
            if (IsValidPlayer(user)) {
                file.cp_table[user] <- file.first_cp
                ...
                if (gen != 0) {
                    ...
                    LocalMsg(user, "#FS_STRING_VAR", "", 2, 5.0, format("%d:%02d", minutes, seconds), "FINAL TIME", "" )
                    user.SetPersistentVar("gen", 0)
                } else {
                    LocalMsg(user, "#FS_STRING_VAR", "", 2, 5.0, "HARD COURSE FINISHED!", "CONGRATULATIONS", "" )
                    user.SetOrigin(file.first_cp)
                    user.SetVelocity( < 0, 0, 0 > )
                }
            }
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 2094.399, -7247.7, 18386 > , < 0, 180, 0 > , "%use% Go to Hard Course"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 2963.737, 12481.08, 14079.62 > , < 0, 90, 0 > , "%use% Go to Lobby"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    user.SetOrigin(file.first_cp)
    ...
    AddCallback_OnUseEntity(CreateFRButton( < 337.3955, -19286.2, 15076.09 > , < 0, 0, 0 > , "%use% Go to Lobby"), void
        function(entity panel, entity user, int input) {
            if (IsValid(user)) {
                if (user.IsPlayer() && user.GetPhysics() != MOVETYPE_NOCLIP) {
                    user.SetOrigin(file.first_cp)
    ...
    trigger_56.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_57.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                if (ent in file.cp_table) {
    ...
    trigger_58.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_59.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_60.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_61.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_62.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                if (ent in file.cp_table) {
    ...
    trigger_63.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_64.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_65.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_66.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_67.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_68.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_69.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_70.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_71.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_72.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_73.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_74.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                if (ent in file.cp_table) {
    ...
    trigger_75.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                if (ent in file.cp_table) {
    ...
    trigger_76.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_77.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_78.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_79.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_80.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                if (ent in file.cp_table) {
    ...
    trigger_81.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_82.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_83.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_84.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                if (ent in file.cp_table) {
    ...
    trigger_85.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_86.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                if (ent in file.cp_table) {
    ...
    trigger_87.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_88.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_89.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                if (ent in file.cp_table) {
    ...
    trigger_90.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_91.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_92.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_93.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_94.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_95.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_96.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_97.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_98.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_99.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                if (ent in file.cp_table) {
    ...
    trigger_100.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_101.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_102.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                if (ent in file.cp_table) {
    ...
    trigger_103.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_104.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                if (ent in file.cp_table) {
    ...
    trigger_105.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_106.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_107.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                if (ent in file.cp_table) {
    ...
    trigger_108.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_109.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_110.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_111.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_112.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_113.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_114.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                if (ent in file.cp_table) {
    ...
    trigger_115.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                if (ent in file.cp_table) {
    ...
    trigger_116.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_117.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                if (ent in file.cp_table) {
    ...
    trigger_118.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_119.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                if (ent in file.cp_table) {
    ...
    trigger_120.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                if (ent in file.cp_table) {
    ...
    trigger_121.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_122.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_123.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_124.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_125.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_126.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_127.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_128.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                if (ent in file.cp_table) {
    ...
    trigger_129.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                if (ent in file.cp_table) {
    ...
    trigger_130.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_131.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_132.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                if (ent in file.cp_table) {
    ...
    trigger_133.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_134.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                if (ent in file.cp_table) {
    ...
    trigger_135.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_136.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_137.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                if (ent in file.cp_table) {
    ...
    trigger_138.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_139.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_140.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_141.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValidPlayer(ent)) {
                if (ent in file.cp_table) {
    ...
    trigger_142.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_143.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_144.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_145.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_146.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_147.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_148.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_149.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_150.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
    ...
    trigger_151.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_152.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_153.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent in file.cp_table) {
    ...
    trigger_900.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
    ...
    trigger_901.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_902.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_903.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_904.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_905.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_906.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_907.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_908.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_909.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9010.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9011.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9012.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9013.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9014.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9015.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9016.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9017.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9018.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9019.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9020.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9021.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9022.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9023.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9024.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9025.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9026.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9027.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9028.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9029.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9030.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9031.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9032.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9033.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9034.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9035.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9036.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9037.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9038.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9039.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9040.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9041.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9042.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9043.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9044.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9045.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9046.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9047.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9048.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9049.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9050.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9051.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9052.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9053.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9054.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9055.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9056.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9057.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9058.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9059.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9060.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9061.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9062.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9063.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9064.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9065.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9066.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
    ...
    trigger_9067.SetEnterCallback(void
        function(entity trigger, entity ent) {
            if (IsValid(ent)) {
                if (ent.IsPlayer() && ent.GetPhysics() != MOVETYPE_NOCLIP) {
                    if (ent.GetPersistentVarAsInt("gen") == 0) {
