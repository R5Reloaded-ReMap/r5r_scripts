...
void function Olympus_OnEntitiesDidLoad() 
{
	...
	entity branthium_crystal = CreatePropDynamic( $"mdl/fx/holo_branthium_crystal.rmdl", <-5347.69, -1035.13, -6060.35>, <-90, 0, 90> )
	entity branthium_structure = CreatePropDynamic( $"mdl/fx/holo_branthium_structure.rmdl", <-5347.69, -1035.13, -6060.35>, <-90, 0, 90> )
	entity branthium_01 = CreatePropDynamic( $"mdl/fx/holo_branthium_01.rmdl", <-5347.69, -1035.13, -6060.35>, <-90, 0, 90> )
	entity branthium_02 = CreatePropDynamic( $"mdl/fx/holo_branthium_02.rmdl", <-5347.69, -1035.13, -6060.35>, <-90, 0, 90> )
