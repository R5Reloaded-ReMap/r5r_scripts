...
//This file is deprecated since we've made a fully featured gamemode with this, check mp/sh_movement_recorder.nut
//People will still able to use the recorder feature in other gamemodes such as aim trainer or dev, that's why I introduced this script back
...
void function StartMovementRecorder(entity player, float length = 10, int character = 0, int shield = 1, float animRate = 1.0 )
{
	...
	{
		Message(player, "ERROR", "sv_cheats must be true", 1.5)
		return
	}
